...
import { AppSidebar } from "@/pages/admin/components/AddSide"; // تأكد من صحة هذا المسار
import { useTheme } from "@/contexts/ThemeProvider";
import { Moon, Sun, Menu, BookOpen } from "lucide-react";
import { Button } from "@/ui/button"; // تأكد من المسار حسب مجلد المشروع
...
// ⚠️ احذف import "@/App" لأنه بيعمل "Circular Dependency" وممكن يعلق الصفحة
    ...
    <div className="min-h-screen flex flex-col w-full bg-slate-50 dark:bg-slate-950 text-right" dir="rtl">
      ...
      <header className="h-24 sticky top-0 z-40 flex items-center justify-between px-8
        ...
        <div className="flex items-center gap-4">
          {/* زر فتح القائمة للموبايل أو السايدبار المتقلص */}
          <Button
            variant="ghost"
            size="icon"
          ...
          <div className="flex items-center gap-3">
             <div className="relative">
                <img
                  src="/slogan.png" // تأكد من وجود سلاش في البداية لضمان المسار الصحيح

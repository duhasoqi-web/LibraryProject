...
export default function LateLoanPage() {
    ...
    <div className="min-h-screen p-6 bg-gradient-to-br from-rose-50/40 to-orange-50/40" dir="rtl">
      <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="max-w-7xl mx-auto">
        ...
        <div className={cn(glassCardClass, "bg-card p-6 h-[600px] flex flex-col")}>
          <AgGridTable
            columnDefs={[
  { field: "memberNumber", headerName: "الرقم", width: 90, filter: true }, // تصغير العرض
  { field: "fullName", headerName: "اسم المشترك", flex: 1.2, minWidth: 150, filter: true }, // إعطاء مساحة أكبر للاسم
  { 
    field: "phoneNumber", 
    headerName: "رقم الجوال", 
    width: 130, 
  },
  { field: "bookTitle", headerName: "عنوان الكتاب", flex: 1.5, minWidth: 150, filter: true }, // مساحة أكبر للعنوان
  { 
    field: "serialNumber", 
  ...
  { 
  field: "actions", // أضيفي هذا السطر هنا ليتم استبعاده من الطباعة
